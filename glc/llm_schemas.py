...
class ChatResponse(BaseModel):
    ...
    # A provider's own reasoning channel, when it separates one out (Ollama's
    # message.thinking, an OpenAI-compat message.reasoning). These tokens are
    # generated and billed regardless of whether anyone reads this field;
    # capturing them costs nothing further. None when the provider did not
    # return one, or did not think.
